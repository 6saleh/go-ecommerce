...
*   **قيد صارم:** **لا تستخدم `لاتوجد قيود حاليا `**. إذا طلب المستخدم ميزة تتطلب جانب خادم، اقترح بديلاً من جانب العميل أو أبلغه بأن الطلب يتعارض مع القيود. 
*   **تفضيل قوي:** **تجنب تعقيدات العرض**. التزم دائمًا بالحل الأبسط الممكن باستخدام HTML/CSS/Vanilla JS أولاً (مبدأ MVS). 
ايظن استخدم لغه go مع فريم ويوك fiber + database sqlit3  والمطلوب انشاء مشروع متجر الاكتروني متوسط ويكون قابل للبيع
 
--- 
